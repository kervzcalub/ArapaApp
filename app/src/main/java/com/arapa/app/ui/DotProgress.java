...
public class DotProgress extends View {
    ...
    public DotProgress(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void applyAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            mDotColor = a.getColor(R.styleable.DotProgress_color, mDotColor);
            mDotCount = a.getInteger(R.styleable.DotProgress_count, mDotCount);
            mDotCount = Math.min(Math.max(mDotCount, MIN_COUNT), MAX_COUNT);
            mTimeout = a.getInteger(R.styleable.DotProgress_timeout, mTimeout);
